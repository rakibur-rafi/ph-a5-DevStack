...
const Footer = () => {
  return (
    <div className="container mx-auto py-12 px-4 mt-20 max-lg:mt-12 max-lg:bg-white border-t border-[#E2E8F0]">
        <div className="flex flex-col gap-12 max-lg:gap-8">
            <div className="flex max-lg:flex-col justify-between">
                <div className="flex flex-col items-center gap-4 text-center lg:items-start lg:text-left">
                    ...
                    <div className="flex gap-4 mt-2">
                        ...
                        <p className="text-[#475569] text-sm font-semibold max-lg:font-normal">•</p>
            ...
            <div className="flex justify-between items-center max-lg:gap-1 border-t border-[#E5E7EB] pt-8 max-lg:pt-6">
                <p className="text-[#64748B] text-sm max-lg:text-xs">© 2026 Dev Stack. All rights reserved.</p>
                <div className="flex items-center gap-4">
                    <a className="text-[#64748B] text-sm max-lg:text-xs" href="">Privacy</a>
                    <a className="text-[#64748B] text-sm max-lg:text-xs" href="">Terms</a>
                </div>
            </div>
        </div>
    </div>
